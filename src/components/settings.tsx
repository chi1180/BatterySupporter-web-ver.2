...
export default function Settings() {
  const is_electron: boolean =
    (typeof window !== "undefined" && window?.electron?.isElectron) ?? false;
                ...
                <ol className={"w-full h-full"}>
                  <li className={"w-full"}>
                    <List
                      ...
                      title={"サインイン時に起動"}
                      inner_content={
                        <SwitchBtn property={"start_on_sign_in"} />
                      }
                    />
                  </li>
                  <li className={"w-full"}>
                    <List
                      ...
                      title={"システムトレイに最小化"}
                      inner_content={
                        <SwitchBtn property={"minimize_in_system_try"} />
                      }
                    />
                  </li>
                </ol>
              ...
              <ol className={"w-full h-full"}>
                <li className={"w-full"}>
                  <List
                    ...
                    title={"バッテリの残量不足を通知"}
                    inner_content={
                      <SwitchBtn property={"notify_battery_insufficient"} />
                    }
                  />
                </li>
              </ol>
